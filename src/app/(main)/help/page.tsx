...
const SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    heading: "口座と利子",
    items: [
      { title: "口座とは", body: "相手ごとに複数の「口座」を作れます。口座は貸し借りのまとまりで、利率や利息の発生タイミングは口座ごとに設定します。口座を分けなければ「通常」口座に記録されます。" },
      { title: "利率は年利で指定", body: "口座の設定ページで年利（%）を指定します。1週間ぶんの利息は「年利 ÷ 52週」で計算します。例えば年利260%なら週5%です。0%にすると無利子になります。" },
      { title: "利息が発生するタイミング", body: "口座ごとに選んだ曜日の朝9時（日本時間）に、週1回だけ利息が発生します。残高がプラス（相手に貸している状態）の口座だけが対象です。" },
