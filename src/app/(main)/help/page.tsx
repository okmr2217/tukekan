...
const SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { label: "残高を確認する", body: "「相手」ページで相手ごとの残高を、「統計」ページで貸し借りの流れや返済の傾向をチェックします。" },
    ],
  },
  {
    icon: ArrowLeftRight,
  ...
  },
  {
    ...
    items: [
      ...
      { title: "相手のアーカイブ", body: "やり取りが一段落した相手をアーカイブすると、ホームの一覧と取引フォームの相手の候補に出なくなります。貸し借りの記録と残高はそのまま残り、ホームの合計・すべての取引・統計にも含まれます。アーカイブ中は利息が付きません。" },
      { title: "アーカイブ済みの相手を見る", body: "ホームの一番下の「アーカイブ済みの相手」から一覧を開けます。解除は相手の設定ページから行います。" },
    ],
  },
  {
    icon: HandCoins,
  ...
  },
  {
    ...
    items: [
      ...
      { title: "相手ごとの統計", body: "相手ページの「統計」から開きます。残高の推移や、その相手がどれくらいで返してくれているか（返済の傾向）を確認できます。口座が複数ある相手は口座ごとに絞り込めます。" },
